...
const projects = [
  {
    ...
    images: [p1, p112],
    link: "https://github.com/Akram17/Real-Estate-Analytics",
  },
  {
    ...
    images: [p2],
    link: "https://github.com/Akram17/E-Payment-Analytics",
  },
  {
    ...
    images: [p3, p32],
    link: "https://github.com/Akram17/Loan-prediction",
  },
  {
    ...
    images: [p4],
    link: "https://github.com/Akram17/Personnal-Finance-Planner",
  },
  {
    title:
      "Enhancing AHP Consistency Through Genetic Algorithm and Artificial Neural Networks",
  ...
  },
  {
    ...
    images: [p6],
    link: "https://github.com/Akram17/-Tesla-stock-price-prediction-using-LSTM-model-",
  },
  {
    ...
    images: [p7],
    link: "https://github.com/Akram17/-Web-Scraping-House-Rental-Prices",
  },
  {
    ...
    images: [p8],
    link: "https://github.com/Akram17/Credit-Card-Customer-Churn-Prediction-Python-",
  },
  {
    ...
    images: [p9],
    link: "https://github.com/Akram17/Customer-Segmentation-Using-K-Means-Clustering",
  },
  {
    title: "HR Dashboard",
    description:
    ...
    images: [p10],
    link: "https://github.com/Akram17/HR-Dashboard-",
  },
  {
    ...
    images: [p11],
    link: "https://github.com/Akram17/-RFM-Analysis-in-Python-",
  },
  {
    ...
    images: [p12],
    link: "https://github.com/Akram17/Gold-Price-Prediction",
  },
  {
    ...
    images: [p13],
    link: "https://github.com/Akram17/Call-Center-Analytics",
  },
  {
    ...
    images: [p14],
    link: "https://github.com/Akram17/Customer-Chrun-Analytics",
  },
  {
    title: "HR Dashboard",
    description:
      "An HR Dashboard that empowers smarter decision-making by providing actionable insights about the workforce",
    images: [p15],
    link: "https://github.com/Akram17/HR-Analytics",
  },
];
    ...
    <section className="bg-[#e6d9cc] py-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mt-16 flex justify-center">
          <a
            href="https://github.com/Akram17?tab=repositories"
            target="_blank"
            rel="noopener noreferrer"
